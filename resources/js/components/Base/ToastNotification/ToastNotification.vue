  ...
  <div class="fixed top-0 right-0 sm:right-5 p-4 transition-opacity w-screen sm:w-fit duration-300 z-[2147483647] flex flex-col gap-3">
    ...
    >
      <div
        ...
        :key="toast.id"
        ref="container"
        class="right-22 p-4 rounded shadow-lg transition-opacity duration-300 flex items-center gap-2 min-w-[350px] w-full sm:w-fit max-w-[550px]"
        :class="[
      ...
      >
        ...
        <!-- Mensaje -->
        <p class="break-words !max-w-[calc(100%-70px)] mb-0">
          {{ toast.message }}
        </p>
